...
class EarlyStopper():
	...
	"""
	def __init__(self, patience: Optional[int] = 25):
		"""
		Constructor for objects of class EarlyStopper.

		Args:
			patience: int indicating how many steps to wait after the last reduction in 
				test loss before stopping training. Defaults to 25.
		"""
